...
10. **hyp_009**: Architecture Alignment -- add pre-norm and layers_per_block to model.py, closing the remaining architectural gap with tarflow_apple.py. Validate at T=9 ethanol, then multi-molecule.
11. **hyp_010**: DDPM -- implement the diffusion baseline with comparable architecture, train and tune (OPTIMIZE).
12. **hyp_011** (conditional): Head-to-head comparison -- TarFlow vs DDPM on all metrics.
