...
13. **hyp_012**: DDPM diffusion baseline -- implement transformer-based denoiser with comparable parameter count. Train and tune (OPTIMIZE).
14. **hyp_013** (conditional): Head-to-head comparison -- TarFlow vs DDPM on all metrics.
