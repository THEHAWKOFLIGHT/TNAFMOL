...
9. **hyp_008**: DDPM -- implement the diffusion baseline with comparable architecture, train and tune (OPTIMIZE).
10. **hyp_009** (conditional): Head-to-head comparison -- TarFlow vs DDPM on all metrics.
