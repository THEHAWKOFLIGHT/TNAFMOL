...
13. **hyp_012**: Permutation Reordering for Boltzmann Accuracy — head-to-head test of whether random permutation augmentation within atom-type equivalence classes improves Boltzmann generation quality. Arm A: canonical ordering, Arm B: type-sorted + within-group permutation. Both OPTIMIZE'd at T=1.0.
